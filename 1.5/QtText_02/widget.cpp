    ...
    : QWidget(parent)
{
    ...
    connect(shapeComboBox,&QComboBox::activated,this,&Widget::ShowShape);
    ...
    connect(penColorBtn,&QPushButton::clicked,this,&Widget::ShowPenColor);
    penWidthLabel = new QLabel(tr("画笔线宽:"));
    penWidthSpinBox = new QSpinBox;
    penWidthSpinBox->setRange(0,20);
    connect(penWidthSpinBox,&QSpinBox::valueChanged,this,&Widget::ShowPenWidth);
    ...
    connect(penStyleComboBox,&QComboBox::activated,this,&Widget::ShowPenStyle);
    ...
    connect(penCapComboBox,&QComboBox::activated,this,&Widget::ShowPenCap);
    ...
    connect(penJoinComboBox,&QComboBox::activated,this,&Widget::ShowPenJoin);
    fillRuleLabel = new QLabel(tr("填充模式:"));
    fillRuleComboBox = new QComboBox;
    fillRuleComboBox->addItem(tr("Odd Even"),Qt::OddEvenFill);
    fillRuleComboBox->addItem(tr("Winding"),Qt::WindingFill);
    connect(fillRuleComboBox,&QComboBox::activated,this,&Widget::ShowFillRule);
    ...
    connect(spreadComboBox,&QComboBox::activated,this,&Widget::ShowSpreadStyle);
    ...
    connect(brushColorBtn,&QPushButton::clicked,this,&Widget::ShowBrushColor);
    ...
    connect(brushStyleComboBox,&QComboBox::activated,this,&Widget::ShowBrush);
